        ...
        while (!testPaths.isEmpty) {
            ...
            for link in links( testPath.target ) {
                ...
                if neighbourCost > budget {
                    ...
                    trc( "neighbour exceeds maximum cost (\(neighbourCost) > \(budget)): \(neighbour)" )
                    continue
                }
                ...
                if (found( neighbour )) {
                    trc( "found neighbour at cost \(neighbourCost): \(neighbour)" )
                    return neighbourPath
                }
                trc( "intermediate neighbour at cost \(neighbourCost): \(neighbour)" )
